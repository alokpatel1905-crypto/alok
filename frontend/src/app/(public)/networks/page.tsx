      ...
      <section className="relative min-h-[70vh] flex items-center pt-40 pb-20 overflow-hidden bg-[#061B14] text-white">
        ...
        <Container className="relative z-10 text-center max-w-5xl preserve-3d">
          <motion.div 
            ...
            className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-flora/10 border border-flora/20 text-flora text-xs font-black uppercase tracking-[0.4em] mb-10 hover-tilt"
          >
